...
class CreateSaleOrderItemChangesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_order_item_changes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sale_order_item_changes');
    }
}
