            ...
            <div class="nk-content ">
                <div class="nk-block nk-block-middle wide-md mx-auto">
                    <div class="nk-block-content nk-error-ld text-center">
                        <img class="nk-error-gfx" src="{{ asset('assets/files/img/errors/error-419.svg') }}" alt="">
                        <div class="wide-xs mx-auto">
                            <h3 class="nk-error-title">Session expired</h3>
                            <p class="nk-error-text">Due to inactivity, your session has expired, no to worry just refresh your browser.</p>
