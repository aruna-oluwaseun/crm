                            ...
                            <div class="nk-block-head " style="padding-bottom: 1.5rem">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h4 class="title nk-block-title">#{{ $detail->id }} Expenses</h4>
                                    </div>
                                    ...
                                    <div class="card-aside-wrap">
                                        <div class="card-inner card-inner-lg">
                                            <div class="nk-block-head nk-block-head-lg">
                                                <div class="nk-block-between">
                                                    <div class="nk-block-head-content">
                                                        <h4 class="nk-block-title">Expenses #{{$detail->id}}</h4>
                                                        <div class="nk-block-des">
                                                            <p>
                                                                Expenses created by <a href="{{ url('users/'.$created_by->id) }}">{{ $created_by->getFullNameAttribute() }}</a> at <b>{{ date('dS F Y H:ia', strtotime($detail->created_at)) }}</b>.
                                                ...
                                                <form method="post" action="{{ url('salesorders/'.$detail->id) }}" id="edit-form" class=" form-validate">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input class="form-control" type="text" name="supplier" value="{{ old('supplier', $detail->supplier_title) }}" <?php echo $customer_locked ? 'readonly="readonly"' : '' ?>>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <input class="form-control" type="text" name="reference" value="{{$detail->reference}}" <?php echo $customer_locked ? 'readonly="readonly"' : '' ?>>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <input class="form-control" type="text" name="last_name" value="{{ $detail->status }}" <?php echo $customer_locked ? 'readonly="readonly"' : '' ?>>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mb-10">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea class="form-control" name="notes" id="notes">{{ $detail->description }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <img width="100px" src="https://jenflow-uploads.s3.eu-west-2.amazonaws.com/images/1625305115IGo3IIJ07IzEm4F2MKNtiDVMGCFpH16u2x0yX9f9.jpeg">
                                                    </div>
                                                                ...
                                                                <div class="simplebar-content" style="padding: 0px;">
                                                                    ...
                                                                    <div class="card-inner">
                                                                        <div class="user-account-info py-0">
                                                                            ...
                                                                            <div class="user-balance preview-gross-cost">&pound;{{ number_format($grosscost, 2, '.',',') }} </div>
                                                                            <div class="user-balance-sub">NET <span class="text-primary preview-net-cost">&pound;{{ number_format($netcost, 2, '.',',') }}</span></div>
                                                                            <div class="user-balance-sub">VAT {{ isset($detail->vatType) ? '@'.$detail->vatType->title : '' }} <span class="preview-vat-cost">&pound;{{ number_format($grosscost - $netcost , 2, '.',',') }} </span></div>
                                                                    ...
                                                                    <div class="card-inner p-0">
                                                                        <ul class="tab-links link-list-menu">
                                                                            ...
                                                                            <li><a href="#tab-order-items"><em class="icon ni ni-grid-plus"></em><span>Items on Expenses</span></a></li>
