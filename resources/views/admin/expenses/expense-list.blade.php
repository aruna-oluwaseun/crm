                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        @can('create-sale-orders')
                                                            <li><a href="{{ url('expenses/create') }}" class="btn btn-white btn-primary"><em class="icon ni ni-plus"></em><span>Add Expenses</span></a></li>
                                                        @endcan
                                ...
                                <div class="card card-preview">
                                    <div class="card-inner" data-select2-id="19">
                                        ...
                                        <div class="card-title-group" data-select2-id="18">
                                            <div class="card-title"><h5 class="title">All Expenses</h5></div>
                                        ...
                                        <table class="nk-tb-list nk-tb-ulist" data-auto-responsive="false"><!-- datatable-init -->
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <th class="nk-tb-col tb-col-md"><span class="sub-text">Payment Type</span></th>
                                                        ...
                                                        <!--<td class="nk-tb-col nk-tb-col-check">
                                                           ...
                                                           <td class="nk-tb-col">
                                                            ...
                                                            <td class="nk-tb-col tb-col-lg">
                                                                <span>£{{ $item->total + ($item->tax/100) }}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md">
                                                            
                                                                <span class="tb-status">{{ $item->first_name }}</span>
                                                            ...
                                                            <td class="nk-tb-col tb-col-md">
                                                                ...
                                                                <span class="tb-status">{{ $item->status }}</span>
                                                            ...
                                                            <td class="nk-tb-col tb-col-md">
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a href="{{ url('expenses/'.$item->id) }}"><em class="icon ni ni-eye"></em><span>View</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
