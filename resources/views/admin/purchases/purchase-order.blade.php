                        ...
                        <div class="nk-content-body">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Purchase Order #{{ $detail->id }}</h4>
                                        </div>
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li><a href="{{ url('purchases/download/'.$detail->id) }}" class="btn btn-white btn-primary"><em class="icon ni ni-download"></em><span>Download PO</span></a></li>
                                                        <li><a href="#" data-toggle="modal" data-target="#modalEmail" class="btn btn-white btn-outline-light"><em class="icon ni ni-mail"></em><span>Email PO</span></a></li>
                            ...
                            <div class="receipt-content">
                                <div class="container bootstrap snippets bootdey">
                                    <div class="row">
                                        <div class="col-md-12">
                                            {{ view('admin.purchases.template.purchase-order-detail',['detail' => $detail]) }}
