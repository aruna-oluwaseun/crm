                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li><a href="{{ url('invoices/download/'.$detail->id) }}" class="btn btn-white btn-primary"><em class="icon ni ni-download"></em><span>Download Invoice</span></a></li>
                                                        <li><a href="#" data-toggle="modal" data-target="#modalEmail" class="btn btn-white btn-outline-light"><em class="icon ni ni-mail"></em><span>Email Invoice</span></a></li>
...
<div class="modal fade" tabindex="-1" id="modalEmail">
    <div class="modal-dialog" role="document">
        {{ view('admin.templates.modals.email-invoice', ['email' => $detail->salesOrder->email,'invoice_id' => $detail->id]) }}
    </div>
</div>
