                                ...
                                <div class="card card-bordered">
                                    <div class="card-aside-wrap">
                                        <div class="card-inner card-inner-lg">
                                                ...
                                                <div class="nk-block-between">
                                                    <div class="nk-block-head-content">
                                                        ...
                                                        <div class="nk-block-des">
                                                            <p>
                                                                Category created by <a href="{{ url('users/'.$created_by->id) }}">{{ $created_by->getFullNameAttribute() }}</a> at <b>{{ date('dS F Y H:ia', strtotime($detail->created_at)) }}</b>.
                                            ...
                                            <?php if(isset($detail->parent) && $detail->parent->count()) : ?>
                                                <div class="mb-5">
                                                    This belongs to a parent category : <a href="{{ url('categories/'. $detail->parent->id) }}" class="btn btn-primary"><em class="icon ni ni-link"></em> {{ $detail->parent->title }}</a>
                                                </div>
                                            ...
                                            <div id="tab-details" class="tab card">
                                                ...
                                                <form method="post" action="{{ url('categories/'.$detail->id) }}" id="caetgory-detail-form" class=" form-validate">
                                                    @csrf
                                                    @method('PUT')
                                            ...
                                            <div id="tab-categories" style="display: none;" class="tab card">
                                                ...
                                                <div class="nk-block-head">
                                                    <div class="nk-block-between">
                                                        <div class="nk-block-head-content">
                                                            <p>You have <strong class="text-primary">{{ $detail->children->count() }}</strong> subcategory.</p>
                                                        </div>

                                                        <div class="nk-block-head-content">
                                                            <a href="#" data-toggle="modal" data-target="#link-category" class="btn btn-white btn-primary"><em class="icon ni ni-plus"></em><span>Link Subcategory</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card card-bordered card-preview">
                                                    <table id="subcategories" class="table table-orders">
                                                        <thead class="tb-odr-head">
                                                            <tr>
                                                                <th>Category</th>
                                                                <th>Products linked</th>
                                                                <th>Subcategory linked</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php foreach($detail->children as $child) : ?>
                                                                ...
                                                                <tr>
                                                                    <td><a href="{{ url('categories/'.$child->id) }}">{{ $child->title }}</a></td>
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                                                <ul class="link-list-plain">
                                                                                    <li><a href="{{ url('categories/'.$child->id) }}" target="_blank" class="text-primary">View</a></li>
                                                                                    <li><a href="{{ url('categories/unlink-category/'.$child->id) }}#tab-categories" class="text-danger destroy-btn">Delete Link</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                ...
                                                <div class="alert alert-warning">No subcategories linked</div>
                                            ...
                                            <div id="tab-products" style="display: none;" class="tab card">
                                                ...
                                                <div class="nk-block-head">
                                                    <div class="nk-block-between">
                                                        ...
                                                        <div class="nk-block-head-content">
                                                            <a href="#linkProductModal" data-toggle="modal" class="btn btn-white btn-primary"><em class="icon ni ni-plus"></em><span>Link Product</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <?php
                                                $prods = $detail->products()->paginate(30)->fragment('tab-products');;
                                                ?>
                                                <div class="card card-bordered card-preview">
                                                    <table id="build-products" class="table table-orders">
                                                        ...
                                                        <tr class="tb-odr-item remove-target" data-id="{{$item->id}}">
                                                            <td class="tb-odr-info">
                                                                <a href="{{ url('products/'.$item->id) }}" target="_blank">{{ $item->title }}</a>
                                                            </td>
                                                                ...
                                                                <div class="simplebar-content" style="padding: 0px;">
                                                                                    ...
                                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                                        <ul class="link-list-opt no-bdr">
                                                                                            ...
                                                                                            <li>
                                                                                                ...
                                                                                                <button type="submit" form="delete-resource" data-message="Please note, all products linked will be unlinked, this may make them harder to find if they are classed an online item" class="destroy-resource btn btn-block btn-sm btn-danger"><em class="icon ni ni-trash-fill"></em><span>Delete Category</span></button>
                                                                                            </li>
                                                                                        </ul>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="card-inner p-0">
                                                                        <ul class="tab-links link-list-menu">
                                                                            ...
                                                                            <li><a href="#tab-categories"><em class="icon ni ni-view-list-fill"></em><span>Subcategories</span></a></li>
...
<div class="modal fade" tabindex="-1" id="linkProductModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Link a product</h5>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info"><atrong>Please note</atrong> : since the categories is only for the online shop, only active products marked "available online" will be available to select int the list below</div>

                <?php if( isset($products) && $products->count() ) : ?>
                <form method="post" action="{{ url('categories/link-product') }}" id="create-form" class=" form-validate">
                    @csrf
                    <input type="hidden" name="category_id" value="{{ $detail->id }}">
                        ...
                        <div class="form-control-wrap">
                            <select class="form-select" name="product_id" id="add-product-id" data-search="on" required>
                                ...
                                <?php foreach($products as $product) : ?>
                                    <?php
                                        // ignore products already linked
                                        if($detail->products()->where('id', $product->id)->count())
                                        {
                                            continue;
                                        }
                                    ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="link-category">
    <div class="modal-dialog modal-md" role="document">
        {{ view('admin.templates.modals.link-category',['field_name' => 'category_id', 'field_id' => $detail->id, 'ignore' => $detail->children()]) }}
    </div><!-- .modla-dialog -->
</div><!-- .modal -->
