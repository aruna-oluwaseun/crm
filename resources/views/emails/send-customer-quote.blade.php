                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="text-align:center;padding: 30px 30px 15px 30px;">
                            <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 600; margin: 0;">Here is your quote</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;padding: 0 30px 20px">
                            <p>Please see attached your quote #{{ $order->id }}. To go ahead with this order please contact us on <a href="tel:{{ env('SUPPORT_PHONE') }}">{{ env('SUPPORT_PHONE') }}</a>  or <a href="mailto:{{ env('SUPPORT_EMAIL') }}">{{ env('SUPPORT_EMAIL') }}</a>. Please note the quote is valid until {{ format_date($order->quote_valid_until) }}.</p>
                        </td>
                    </tr>
                    <tr>
