                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="text-align:center;padding: 30px 30px 15px 30px;">
                            <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 600; margin: 0;">You have a refund</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;padding: 0 30px 20px">
                            <p>Please see attached your refund #{{ $refund->id }}. Please note refunds can take 5-7 days to arrive in your account, if you have any questions or queries about your refund please contact us <a href="tel:{{ env('SUPPORT_PHONE') }}">{{ env('SUPPORT_PHONE') }}</a>  or <a href="mailto:{{ env('SUPPORT_EMAIL') }}">{{ env('SUPPORT_EMAIL') }}</a>.</p>
                        </td>
                    </tr>
                    <tr>
