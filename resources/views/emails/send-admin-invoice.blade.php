                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="text-align:center;padding: 30px 30px 15px 30px;">
                            <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 600; margin: 0;">An invoice payment has been received</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;padding: 0 30px 20px">
                            <p>Please see attached #{{ $invoice->id }} for your records.</p>
                            <p>
                                <br><h4>Manage this order by logging into your account</h4>
                                <a href="{{ url('invoices/detail/'.$invoice->id) }}">Manage invoice</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
