                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="text-align:center;padding: 30px 30px 15px 30px;">
                            <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 600; margin: 0;">Please find attached a new purchase order</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;padding: 0 30px 20px">
                            <p>Please see attached purchase order #{{ $order->id }}. Please confirm the prices and delivery date, if you have any questions please contact us <a href="tel:{{ env('SUPPORT_PHONE') }}">{{ env('SUPPORT_PHONE') }}</a>  or <a href="mailto:{{ env('SUPPORT_EMAIL') }}">{{ env('SUPPORT_EMAIL') }}</a>.</p>
                        </td>
                    </tr>
                    <tr>
