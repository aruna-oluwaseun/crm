...
!function (NioApp, $) {
  ...
  NioApp.Dropzone = function (elm, opt) {
    /*if ($(elm).exists()) {
        $(elm).each(function () {
            var accepted_files = $(this).data('accepted-files') ? $(this).data('accepted-files') : null;
            var url = $(this).data('url') ? $(this).data('url') : "/upload";
             var def = {
                autoDiscover: false,
  ...
  /**
   * Using custom for streaming to S3
   */
...
module.exports = __webpack_require__(/*! /Users/richardholmes/Sites/localhost/jenflow-laravel/resources/js/admin/scripts.js */"./resources/js/admin/scripts.js");
