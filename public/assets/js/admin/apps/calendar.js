...
/***/ "./resources/js/admin/apps/calendar.js":
/*!*********************************************!*\
  !*** ./resources/js/admin/apps/calendar.js ***!
  \*********************************************/
  ...
  NioApp.Calendar = function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      eventDrop: function eventDrop(info) {
        ...
        startTime = startTime[startTime.length - 2]; //startTime = startTime == '00:00:00' ? '' : startTime;
        ...
        $('#edit-event-end-date').val(endDate).datepicker('update'); //$('#edit-event-start-time').val(startTime);
        ...
        $('#edit-user-id').val(user_id).trigger('change.select2'); // Change the event
      ...
      eventClick: function eventClick(info) {
        ...
        if (!is_background_event) {
          ...
          $('#edit-event-id').val(eventId);
          $('#edit-event-type :input[value="' + type + '"]').prop('checked', true);
          $('#edit-user-id').val(user_id).trigger('change.select2'); // Preview Event
          ...
          if (response.success) {
            ...
            if (pending) {
              Swal.fire({
                icon: 'success',
                title: 'Sorted',
                text: 'Your holiday request has been sent for approval, you will be notified once request has been looked into.' //footer: '<a href>Why do I have this issue?</a>'
            ...
            Swal.fire({
              icon: 'error',
              title: 'Oops...',
              text: message ? message : 'Error adding to calendar.' //footer: '<a href>Why do I have this issue?</a>'
        ...
        success: function success(response) {
          ...
          if (response.success) {
            ...
            Swal.fire({
              icon: 'error',
              title: 'Oops...',
              text: message ? message : 'Error updating calendar.' //footer: '<a href>Why do I have this issue?</a>'
          ...
          success: function success(response) {
            ...
            if (response.success) {
              ...
              Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: response.message ? response.message : 'Error removing from calendar.' //footer: '<a href>Why do I have this issue?</a>'
...
/***/ 2:
/*!***************************************************!*\
  !*** multi ./resources/js/admin/apps/calendar.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/richardholmes/Sites/localhost/jenflow-laravel/resources/js/admin/apps/calendar.js */"./resources/js/admin/apps/calendar.js");
